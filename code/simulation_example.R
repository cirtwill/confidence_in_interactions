...
write.table(A_props,file='../data/simulation_example/A_props.tsv',sep='\t')
write.table(B_props,file='../data/simulation_example/B_props.tsv',sep='\t')
write.table(C_props,file='../data/simulation_example/C_props.tsv',sep='\t')
