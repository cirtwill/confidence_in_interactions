...
def format_graph(graph,nettype):
  ...
  if nettype=='SG':
    graph.legend.configure(box_linestyle=0,fill=0,fill_pattern=0,char_size=.75,
      loc=(0.24,40),loctype='world',size=2)
    ...
    graph.add_drawing_object(DrawText,text=\
      LatexString('n\sij'),x=0.255,y=40.5,char_size=.75,just=2,loctype='world')
  elif nettype=='GP':
    graph.legend.configure(box_linestyle=0,fill=0,fill_pattern=0,char_size=.75,
      loc=(0.24,40),loctype='world',size=2)
    # graph.add_drawing_object(DrawText,text="N",x=0.665,y=35.5,char_size=.75,just=2,loctype='world')
...
grace=MultiPanelGrace(colors=colors)
grace.add_label_scheme('dummy',['A: Reasonable prior','B: Unreasonable prior'])
grace.set_label_scheme('dummy')
for subdir in ['Zillis/','']:


  xdata=read_Rfiles('../../data/Salix_example/'+subdir+'Galler_Parasitoid/distfigure_xvals.tsv')
  ydata=read_Rfiles('../../data/Salix_example/'+subdir+'Galler_Parasitoid/distfigure_yvals.tsv')
  MLEfile='../../data/Salix_example/'+subdir+'Galler_Parasitoid/distfigure_MLEs.tsv'
...
grace.multi(rows=2,cols=1,vgap=.05)
...
grace.write_file('../../manuscript/figures/GP_pdfs_prior_comparison.eps')
...
grace.set_label_scheme('dummy')
for subdir in ['Zillis/','']:
  xdata=read_Rfiles('../../data/Salix_example/'+subdir+'Salix_Galler/distfigure_xvals.tsv')
  ydata=read_Rfiles('../../data/Salix_example/'+subdir+'Salix_Galler/distfigure_yvals.tsv')
  MLEfile='../../data/Salix_example/'+subdir+'Salix_Galler/distfigure_MLEs.tsv'
  # xdata=read_Rfiles('../../data/Salix_example/Zillis/Galler_Parasitoid/distfigure_xvals.tsv')
  # ydata=read_Rfiles('../../data/Salix_example/Zillis/Galler_Parasitoid/distfigure_yvals.tsv')
  # MLEfile='../../data/Salix_example/Zillis/Galler_Parasitoid/distfigure_MLEs.tsv'
...
grace.write_file('../../manuscript/figures/SG_pdfs_prior_comparison.eps')
