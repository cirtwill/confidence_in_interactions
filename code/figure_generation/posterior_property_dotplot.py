# This makes the posterior property plot for the Barbour prior, SG and GP components together
...
def populate_graph(graph,prop,nettype,obs,whiskers):
  ...
  obsline.line.configure(linestyle=3,linewidth=2,color='red')
