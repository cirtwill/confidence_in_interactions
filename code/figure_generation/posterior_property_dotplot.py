  ...
  for prop in ['C','LS','LG','NODF']:
    for nettype in ['SG','GP']:
      ...
      if prop=='C':
        ...
        whiskers,obs=read_summary_file('../../data/randomised_webs/'+nettype+'_NODF_table.tsv') # Galler or parasitoid
