...
\section*{Case study: estimating the uncertainty of a plant-herbivore network}
    ...
    \subsection*{Computing the posterior distribution}
      ...
      $\hat{\lambda_{ij}}$=7.405645 $\times$ 10$^{-3}$, var($\lambda_{ij}$)=1.938755 $\times$ 10$^{-5}$ for the \emph{Salix}-galler network and 
  ...
  \subsection*{Computing the credible interval around a probability estimate}
      ...
      \begin{table}[h]
        ...
        \hline
        0   & 0.157 & 0.901 & 0.008 & 0.364 \\
        2   & 0.099 & 0.743 & 0.006 & 0.313 \\
        4   & 0.072 & 0.621 & 0.006 & 0.274 \\
        6   & 0.057 & 0.530 & 0.005 & 0.244 \\
        8   & 0.047 & 0.462 & 0.004 & 0.219 \\
        10  & 0.040 & 0.408 & 0.004 & 0.200 \\
        14  & 0.031 & 0.331 & 0.003 & 0.169 \\
        20  & 0.023 & 0.258 & 0.003 & 0.137 \\
        30  & 0.016 & 0.188 & 0.002 & 0.104 \\
        40  & 0.012 & 0.148 & 0.002 & 0.084 \\
        50  & 0.010 & 0.122 & 0.001 & 0.071 \\
        \hline                  
        374 & 0.001 & 0.018 & \textless0.001 & 0.011 \\
        \hline
        \end{tabular}
        \end{table}
