...
% \clearpage
  ...
  \begin{figure}[h!]
    ...
    After applying these three layers of uncertainty, some interactions which truly occur are very unlikely to be observed. An observed matrix sampled based on this matrix (lower right) is thus likely to contain far fewer interactions than the original, true matrix.}
