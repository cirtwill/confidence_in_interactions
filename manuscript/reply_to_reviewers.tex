...
% ----------------------------------------------------------------------
% ----------------------------------------------------------------------
{\Large \bf Reply to Reviewer \#1} [[done]]
% ---------------------------------------

	1. Suggestion to refocus on prior selection [[done]]
		...
		\textbf{R:} We thank the Reviewer for the suggestion to expand our discussion of prior selection, particularly with regard to approxmimate/empirical Bayes. Although we are somewhat space-limited, we have expanded our description of different priors available and why a researcher might choose one over another (lines XX-XX). We also touch upon the controversy over using empirical priors (lines XX-XX) although we were unable to find many references addressing this in detail. If the Reviewer has particular works in mind, we would be more than happy to include them. We hope that this expanded description will be a better guide for empiricists who may not be familiar with Bayesian statistics.
		\medskip
	...
	2. Suggestion to add more literature [[done]]
		...
		\textbf{R:} We thank the Reviewer for their compliments to our introduction and for the literature recommendations. We have incorporated these reference as suggested. Following comments from other reviewers, we have refined and slightly restructured our introduction in the hope of more clearly establishing the goal of our manuscript ('narrowing our net'). We hope that this revised introduction will also meet with the Reviewer's approval. 
	...
	3. Suggestion to de-emphasize MLE estimate and get straight to Bayes [[done]]
		...
		\textbf{R:} The MLE estimate is part of the Bayesian framework as it dictates the shape of the distribution we use. We now introduce the MLE formally within this context (lines XX-XX) and take care to be explicit when using it to explore the sample size needed in the absence of prior knowledge later (lines XX-XX).
		...
		\begin{quotation}
			The number of observed co-occurrences needed to believe that an unobserved interaction cannot occur is very high (about 35; Fig.~\ref{upper_limits}), and most datasets will not include this level of sampling for all pairs of species~\citep{Bartomeus2013}.
		\end{quotation}
...
% ----------------------------------------------------------------------
% ---------------------------------------------------------------------
{\Large \bf Reply to Referee \#2} [[not started]]
% ---------------------------------------
