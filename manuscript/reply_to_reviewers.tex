...
% ---------------------------------------
	...
	2. Non-independence of interactions not accounted for [written, not done]
		...
		\textbf{R:} We agree wholeheartedly that ecological interactions are often not independent. Indeed, we refer several times to the effect of species' abundances on their probabilities of interacting. This effect alone will introduce non-independence in interaction probabilities, as all interactions involving a common species will be more likely than they would be if that species was rare. That said, we also agree that we do not explicitly discuss the non-independence of interactions. In part, this is by design. We explicitly want to keep our mathematical framework quite simple so that it is easily applicable to a wide variety of situations (including those where the nature of non-independence among interactions is not known). Nevertheless, to encourage readers to consider non-independence when designing their priors we are happy to take the Reviewer's suggestion and index our variables by ij and add a line noting that the assumption of independent interactions may not hold. 
