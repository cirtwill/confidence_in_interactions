...
% ---------------------------------------
	...
	2. Non-independence of interactions not accounted for 
		...
		\begin{quotation}
	        ...
	        Using an informative prior tailors the level of uncertainty surrounding each interaction and may account for non-independence of interactions (as in abundance-based or KNN models).
	    \end{quotation}
