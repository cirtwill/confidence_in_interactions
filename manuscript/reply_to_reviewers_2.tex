...
% ---------------------------------------
	...
	2. Emphasize the drawbacks of empirical Bayes
		...
		Finally, please note that we do discuss caveats to the empirical Bayes approach in lines 272-281, including the possibility that priors based on substantailly different systems will be misleading (with reference to \emph{Appendix S7}) and that published data may reflect under-sampled data:
