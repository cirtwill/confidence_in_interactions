...
This is the pre-peer reviewed version. This article has been published in final form at \textbf{Methods in Ecology and Evolution} (DOI: 10.1111/2041-210X.13180). This article may be used for non-commercial purposes in accordance with Wiley Terms and Conditions for Use of Self-Archived Versions. Text of the peer-reviewed accepted version will be uploaded March 26, 2020.
...
\clearpage
  ...
  \begin{figure}[h!]
      ...
      \label{histograms}
      \begin{center}
      \includegraphics*[width=.7\textwidth]{figures/Salix_Galler_histogram.eps}
      \end{center}
      \end{figure}
