...
\section*{Appendix S1: Obtaining prior interaction probabilities}
    ...
    \subsection*{Degree distributions and interaction probabilities}
      ...
      % deg_dist_parasitoid=rowSums(prior_web_para_only)/ncol(prior_web_para_only)
      % deg_dist_parasitized=colSums(prior_web_para_only)/nrow(prior_web_para_only)
      % gp_int_probs=deg_dist_parasitized%*%t(deg_dist_parasitoid)
