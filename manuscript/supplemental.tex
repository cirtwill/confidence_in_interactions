...
\section*{Appendix S1: Detailed description of mathematical framework}
...
\section*{Appendix S4: Results for \emph{Salix}-galler component}
    ...
    \subsection*{Computing the prior and posterior distributions}
      ...
      As with the galler-natural enemy component, we estimated frequencies of \emph{Salix}-galler interactions based on the normalised degree of each species (\emph{Appendix S6}). We obtained prior parameters of $\alpha$=8.72, $\beta$=305 for the \emph{Salix}-galler component. These prior parameters were then used to estimate the posterior distribution. 
...
\section*{Appendix S8: Calculating the credible interval around a probability estimate}
